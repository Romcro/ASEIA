...
// Contenu de l'email
$contenu = 'Vous avez reçu un message de ' . $prenom . ' ' . $nom .  ', de la société : ' . $structure . ' dont l\'adresse mail est : ' . $email . '. ce message concerne : ' . $sujet . ', et sa demande est la suivante : ' . $message . '.';
// Envoi email	
